...
class JsonWriter {
    ...
    static String writeToString(Object object) {
    ...
    private static void navigateObjectTree(Object object, JsonObjectBuilder objectBuilder) {
    ...
    private static void navigateArrayTree(Object object, JsonArrayBuilder arrayBuilder) {
    ...
    private static void completeObject(Class<?> clazz, String name, Object object, JsonObjectBuilder objectBuilder) {
        Object fieldValue = MyReflectionHelper.getFieldValue(object, name);
        if (fieldValue != null) {
